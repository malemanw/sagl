...
function al_dia() {
	...
	$.post("<?php echo $urlweb?>/servicios/ws_<?php echo $idpanel?>.php?accion=al_dia", { idexpediente: idexpediente, año_escolar: año_escolar}, function(data){
			try{
			console.log(data);
...
function mora() {
	idexpediente = $("#txtexpediente").val()
	año_escolar = $("#seleccionaño").val();
	$.post("<?php echo $urlweb?>/servicios/ws_<?php echo $idpanel?>.php?accion=mora", { idexpediente: idexpediente, año_escolar: año_escolar}, function(data){
			try{
			console.log(data);
			if(data.type=="success"){
				Materialize.toast(data.text, 4000);
