...
?>
<h3 class="center grey-text">Entrega de Calificaciones</h3>
<div class="row">
...
<option value="" disabled selected>Seleccione un año escolar</option>
  ...
  if($funciones->login_admin()){
	?>  
  <div class="col s12 l6">
  <h5>Reiniciar las boletas entregadas.</h5>
...
<div style="font-size: 13px;" id="contenedor_tabla">
	      <table id="tbldata" class="display nowrap centered" style="width:100%; font-size:small;">
        <thead>
          <tr>
              <th>Expediente</th>
...
$(document).ready( function () {
   ...
   searchPanes:{
	...
	$('#tbldata').DataTable().searchPanes.rebuildPane();
