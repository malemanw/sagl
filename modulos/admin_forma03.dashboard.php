...
<script>
  ...
  destroy:true,
   ...
   "columns":[
    ...
    {"data":"nombre_curso"},
    {"data":"descripcion"},
    {"defaultContent": "<a class='obtener btn red'><i class='material-icons'>local_printshop</i></a>"}
],    
...
var obtener_data = function(tbody, table){
    $(tbody).on("click", "a.obtener", function(){
        ...
        console.log(data); 
var idaño = $("#seleccionaño").val(); 
window.open("<?php echo $urlweb?>reportes/rpt_forma03.php?idexpediente="+data.idexpediente+"&idaño="+idaño,
  '_blank');                       
}       
    });
}
